    ...
    <div className="document-viewer">
      ...
      <div className="document-toolbar">
        ...
        <div className="zoom-controls">
          <button onClick={zoomOut} className="btn btn-sm">Zoom Out</button>
          <span className="zoom-level">{Math.round(scale * 100)}%</span>
          <button onClick={zoomIn} className="btn btn-sm">Zoom In</button>
          <button onClick={resetZoom} className="btn btn-sm">Reset</button>
        </div>
      </div>
